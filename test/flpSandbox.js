		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sierra Cash Application",
									"targetURL": "#autocleaningcashapplication-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"autocleaningcashapplication-display": {
								"semanticObject": "autocleaningcashapplication",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=autocleaning.cashapplication",
									"url": sap.ui.require.toUrl("autocleaning/cashapplication")
								}
							}
						}
					}
